...
//            admin.listTableDescriptors();
    ...
    public List<String> getColumnValueFilter(String tableName, String family, String targetColumn, String queryColumn, String queryColumnValue) {
        List<String> returnList = new ArrayList<>();
        try {
            Table table = connection.getTable(TableName.valueOf(tableName));
            SingleColumnValueFilter filter = new SingleColumnValueFilter(Bytes.toBytes(family)
                    , Bytes.toBytes(queryColumn)
                    , CompareOperator.EQUAL
                    , Bytes.toBytes(queryColumnValue));
            Scan scan = new Scan();
    ...
    public List<String> getColumnPrefixFilter(String tableName, String family, String targetColumn, String queryColumnPrefix) {
        List<String> returnList = new ArrayList<>();
        try {
            Table table = connection.getTable(TableName.valueOf(tableName));
//            多个列名前缀
